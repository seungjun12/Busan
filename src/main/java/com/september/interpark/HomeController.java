package com.september.interpark;
...
public class HomeController {
	 ...
	 * 
	 * Date date = new Date(); 시간나오게 해주는것 DateFormat dateFormat =
	...
	public String codeForm(Locale locale, Model model) {
		return "codeForm";
	}
	...
	public String codeGroupForm(Locale locale, Model model) {
